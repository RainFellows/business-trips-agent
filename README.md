...
- **External Configuration**: Manage settings (Home city, ignored domains, etc.) directly in a "Konfigurace" sheet.
- **Improved UI**: Auto-resized columns and better sheet design.
